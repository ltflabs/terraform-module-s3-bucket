...
output "snowflake_storage_integration_integration_name" {
  value = snowflake_storage_integration.integration.name
}

output "snowflake_storage_integration_integration_user_arn" {
  value = snowflake_storage_integration.integration.storage_aws_iam_user_arn
}

output "snowflake_storage_integration_integration_external_id" {
